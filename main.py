...
def set_game_and_start() -> None:
    """
    Makes the user choose all the settings and then start the game.
    """
    ...
    GameManager(lines, columns, marks_to_win_the_game, tuple(player_list)).start_game()
